        ...
        >
          ...
          <div className="glass-card p-8 md:p-12 max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-4">
              <p>
                Hello! I'm <span className="text-gray-900 dark:text-white font-medium">Vanapalli Jaswanth</span>, an aspiring Full Stack Developer with a strong foundation in Java, Spring Boot, and Data Structures & Algorithms. 
              </p>
              <p>
